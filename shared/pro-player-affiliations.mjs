...
export const proPlayerAffiliations = {
  ...
  'alejandro angel lara': affiliation('Indy Ball/International', 'Yuba-Sutter High Wheelers'),
  ...
  'austin sargent': affiliation('Indy Ball/International', 'Austin Weirdos'),
  ...
  'caleb mcneely': affiliation('Indy Ball/International', 'Cleburne Railroaders'),
  ...
  'dylan leek': affiliation('Indy Ball/International', 'Dublin Leprechauns'),
  'eli pitts': affiliation('MILB', 'ACL Reds', 'Cincinnati Reds'),
  'emilio corona': affiliation('Indy Ball/International', 'Long Beach Coast'),
  ...
  'jacob klinovsky': affiliation('Indy Ball/International', 'Martinez Sturgeon'),
  ...
  'josh lester': affiliation('Indy Ball/International', 'Sultanes de Monterrey'),
  'kellen strahm': affiliation('Indy Ball/International', 'Sultanes de Monterrey'),
  ...
  'marcus chiu': affiliation('Indy Ball/International', 'Long Island Ducks'),
  ...
  'rio ruiz': affiliation('Indy Ball/International', 'Diablos Rojos del Mexico'),
